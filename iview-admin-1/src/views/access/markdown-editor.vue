...
<template>
    ...
    <Row class="margin-top-10">
        ...
        <Card>
            ...
            <Row>
                <Col span="20">
                <input v-model="searchConName3" style="width:100%; height:30px;" placeholder="请输入资源名搜索..."  />
                </Col>
                <Col span="4">
        ...
        <Card>
            ...
            <Button @click="handleCancel3" type="ghost">+添加</Button></Button>
        </Card>
        </Col>
    </Row>
...
<script>
    ...
    import tableData from './markdown-data.js';
